      ...
      <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="flex items-center gap-2 text-gray-700 mb-2">
              <Mail /> <span>info@infinitelearn.com</span>
            </div>
          </div>
          ...
          {/* Social Links */}
            ...
            <div className="flex gap-6 text-2xl text-gray-700 cursor-pointer">
                ...
                onClick={() =>
                    window.open("https://www.linkedin.com/in/sandesh-poudel-1o1/", "_blank")
                }
                />
                <Instagram
                className="hover:text-black transition"
                ...
                <Github
                className="hover:text-black transition"
                onClick={() => window.open("https://github.com/Poudel12/OnlineLearning", "_blank")}
                />
            </div>
            </div>
