    ...
    <div className="bg-gray-50 py-16 px-6 md:px-20 text-gray-800">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-5xl font-extrabold mb-6 text-center text-gray-800 tracking-tight">
          About <span className="text-gray-800">InfiniteLearn</span>
        </h1>
        ...
        <div className="flex flex-col md:flex-row items-center gap-10 mb-20">
          ...
          <div className="md:w-1/2">
            ...
            <p className="text-gray-700">
              <span className="font-semibold text-gray-800">InfiniteLearn</span> is a dynamic team of educators,
        ...
        <div className="text-center mt-10">
          ...
          <p className="text-gray-700 max-w-2xl mx-auto">
            Thank you for choosing <span className="font-semibold text-gray-800">InfiniteLearn</span>. 
